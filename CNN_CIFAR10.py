...
test_dataset = torchvision.datasets.CIFAR10(root='./data_cifar10', train=False, transform=transform, download=False)
...
#training loop
n_training_steps = len(train_dataloader)
...
for epoch in range(num_epochs):
    for i, (images, labels) in enumerate(train_dataloader):
        ...
        if (i+1)%10 == 0:
            print(f'epochs {epoch}/{num_epochs} {i+1}/{n_training_steps}')
